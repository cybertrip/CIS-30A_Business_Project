...
class appointment(schedule):
	def __init__(self, subject=None, destination=None, expected=None, company=None, contact=None, hours=None, room=None, agent=None):
...
class delivery(schedule):
	def __init__(self, subject=None, destination=None, expected=None, company=None, tracking=None, origin=None, departed=None, items=None):
		super().__init__(subject, destination, expected, company)
